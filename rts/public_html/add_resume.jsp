...
<html:html>
  <head>
    <title><bean:message key="title.AddResume" /></title>
    ...
    <script name="javascript">
      ...
      function cancelUploadForTree(){
        //alert(document.forms[0].txtCommunicationSkill.value);
      ...
      function parse(thisForm){
       ...
       for(var index=0 ; index < lineText.length ; index++){
         if((lineText[index]).indexOf("@")!=-1 && ((lineText[index]).indexOf(".com")!=-1 || lineText[index].indexOf(".edu")!=-1 || lineText[index].indexOf(".org")!=-1 || lineText[index].indexOf(".co.")!=-1 || lineText[index].indexOf(".net")!=-1 )){
           if(mailIndex==-1){
              mailIndex=index;
  ...
  <body>
    <html:form action="/newDocUploadAction" enctype="multipart/form-data" focus="txaGrab" method="post" name ="docUploadForm" type="rts.web.actionforms.filesystem.DocUploadForm" >
        ...
        <tr>
          <td height="px" align="center" valign="top" class="bgColor_e8e8e8">
            <table width="770px" border="0" cellpadding="1" cellspacing="1" class="bdrColor_336633" style="margin-top:20px; margin-bottom:20px">
              ...
              <tr>
                <td align="right" valign="top">Contact Grabber : </td>
              ...
              <tr>
                <td height="30px" colspan="3">
                  <table width="100%"  border="0" cellspacing="2" cellpadding="2">
                    <tr>
                      ...
                      <td width="30%"><html:text name="docUploadForm" property="txtName" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" tabindex="3" onkeypress="return charOnly(event);" /></td>
                      <td width="18%" align="right"><span class="textRed">* </span><bean:message key="txt.CommunicationSkills" />:</td>
                      <td width="37%">
                        <html:select name="docUploadForm"  property="txtCommunicationSkill" styleClass="bdrColor_336633  componentStyle" style="width:200px;height:18px;" tabindex="8" >
                    ...
                    <tr>
                      ...
                      <td><html:textarea name="docUploadForm" property="txaAddress" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:80px" tabindex="4" /></td>
                      <td align="right" valign="top"><bean:message key="txt.Description" />:</td>
                      <td><html:textarea name="docUploadForm" property="txtFileDesc" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:80px" tabindex="9" /></td>
                    </tr>
                    <tr>
                      <td align="right"><span class="textRed">* </span><bean:message key="txt.Phone1" />:</td>
                      <td><html:text name="docUploadForm" property="txtPhone1" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" onkeypress="return phoneNosOnly(event);" tabindex="5" /></td>
                      <td align="right">Avail Date:</td>
                      <td><html:text name="docUploadForm" property="txtAvailDate" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" tabindex="10" /></td>
                    </tr>
                    <tr>
                      <td align="right">Phone 2:</td>
                      <td><html:text name="docUploadForm" property="txtPhone2" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" onkeypress="return phoneNosOnly(event);" tabindex="6" /></td>
                      <td align="right"><span class="textRed">* </span><bean:message key="lbl.BillingRate" />:</td>
                      <td><html:text name="docUploadForm" property="txtBillingRate" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" tabindex="11" /></td>
                    </tr>
                    <tr>
                      <td align="right"><span class="textRed">* </span><bean:message key="txt.Email" />:</td>
                      <td><html:text name="docUploadForm" property="txtEmail" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" tabindex="7" /></td>
                      <td align="right">&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                  </table>
                ...
                <td height="30px" colspan="3">
          				<table width="100%"  border="0" cellspacing="2" cellpadding="2">
                    <tr valign="top">
                      <td width="15%" align="right"><bean:write name="docUploadForm" property="txtCustom1Lbl" />:</td>
                      <td width="30%"><html:text name="docUploadForm" property="txtCustom1Desc" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" tabindex="12" /></td>
                      <td width="18%" align="right"><bean:write name="docUploadForm" property="txtCustom3Lbl" />:</td>
                      <td width="37%"><html:text name="docUploadForm" property="txtCustom3Desc" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" tabindex="14" /></td>
                    </tr>
                    <tr valign="top">
                      <td align="right"><bean:write name="docUploadForm" property="txtCustom2Lbl" />:</td>
                      <td><html:text name="docUploadForm" property="txtCustom2Desc" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" tabindex="13" /></td>
                      <td align="right"><bean:write name="docUploadForm" property="txtCustom4Lbl" />:</td>
                      <td><html:text name="docUploadForm" property="txtCustom4Desc" styleClass="bdrColor_336633  componentStyle" style="width:200px; height:18px" tabindex="15" /></td>
                    </tr>
                </table>
      				</td>
            </tr>
            <% if(!(((Boolean)request.getAttribute("fromClient")).booleanValue())){ %>
            <tr>
              <td align="right" height="40px"><bean:message key="txt.Resume" />:</td>
              <td colspan="2">
                <html:file name="docUploadForm" property="fileOne" size="96" styleClass="bdrColor_336633" onkeypress="return false;" tabindex="16" ><bean:message key="btn.Browse" /></html:file>
              </td>
            </tr>
            <% }else{ %>
            <tr>
              <td align="right" height="40px"><bean:message key="txt.Resume" />:</td>
              <td colspan="2">
                <html:file name="docUploadForm" property="fileOne" size="96" styleClass="bdrColor_336633"   tabindex="16" ><bean:message key="btn.Browse" /></html:file>
              </td>
            </tr>
            <% } %>
            <tr>
                ...
                <table width="590px" height="50px" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="567px" rowspan="2" height="50px">
                      <html:select name="docUploadForm" property="lstAttachment" size="4" multiple="true" style="width:567px;" styleClass="bdrColor_336633 componentStyle">
                        <logic:present name="docUploadForm" property="lstAttachment">
                          <html:options name="docUploadForm" property="lstAttachment" />
                        </logic:present>
                      </html:select>
                    </td>
            ...
            <tr>
              ...
              <td colspan="2" align="right">
                <html:button property="btnSave" onclick="resumeUpload();" styleClass="buttons" style="width:70px" tabindex="19"><bean:message key="btn.Save" /></html:button>
                <%if(userPreferences.getNavigationType() == UserPreferences.FLAT_NAVIGATION){%>
                  <html:button property="btnCancel" onclick="return cancelUpload();" styleClass="buttons" style="width:70px;margin-right:80px" tabindex="20"><bean:message key="btn.Cancel" /></html:button>
                <%}else{%>
                  <html:button property="btnCancel" onclick="return cancelUploadForTree();" styleClass="buttons" style="width:70px;margin-right:80px" tabindex="20"><bean:message key="btn.Cancel" /></html:button>
                <%}%>
              </td>
            </tr>
          </table>		
