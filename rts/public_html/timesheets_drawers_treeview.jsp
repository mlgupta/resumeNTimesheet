  ...
  <head>
    ...
    function b4CopyMoveFolderDocTo(actionType){
        ...
        if (itemSelected){
            ...
            alert("<bean:message key="msg.drawerTimesheet.not.selected" />");
...
function docEdit(){
  ...
  <body>
    <html:form name="folderDocListForm" action="/timesheetTreeListAction" type="rts.web.actionforms.filesystem.FolderDocListForm" >
                ...
                <td height="30px" colspan="2">
                  ...
                  <logic:equal name="folderDocInfo" property="listingType" value="<%=FolderDocInfo.SIMPLE_LISTING%>" >
                    ...
                    <%if( !((Boolean)request.getAttribute("isRootFolder")).booleanValue() ){ %>
                      ...
                      <a  onclick="folderDocCut()" class="imgCut" onmouseout="this.className='imgCut'" onmouseover="this.className='imgCut'" title="<bean:message key="tooltips.DrawerTimesheetCut" />" style="margin-left:2px"></a>
    
                      <a  onclick="folderDocCopy()" class="imgCopy" onmouseout="this.className='imgCopy'" onmouseover="this.className='imgCopy'" title="<bean:message key="tooltips.DrawerTimesheetCopy" />" style="margin-left:2px"></a>

                      <a  onclick="folderDocPaste()" class="imgPaste" onmouseout="this.className='imgPaste'" onmouseover="this.className='imgPaste'" title="<bean:message key="tooltips.DrawerTimesheetPaste" />" style="margin-left:2px"></a>
            
                      <a  onclick="folderDelete();" class="imgDeleteFolder" onmouseout="this.className='imgDeleteFolder'" onmouseover="this.className='imgDeleteFolder'" title="<bean:message key="tooltips.DrawerTimesheetDelete" />" style="margin-left:2px"></a>
            
                      <a  onclick="b4CopyMoveFolderDocTo('COPY')" class="imgCopyTo" onmouseout="this.className='imgCopyTo'" onmouseover="this.className='imgCopyTo'" title="<bean:message key="tooltips.DrawerTimesheetCopyTo" />" style="margin-left:2px"></a>
            
                      <a  onclick="b4CopyMoveFolderDocTo('MOVE')" class="imgMoveTo" onmouseout="this.className='imgMoveTo'" onmouseover="this.className='imgMoveTo'" title="<bean:message key="tooltips.DrawerTimesheetMoveTo" />" style="margin-left:2px"></a>
            ...
            <tr>
              ...
              <%if( folderDocInfo.isTreeVisible() ){%>
                <div id="treeDiv" class="bdrColor_336633 bgColor_e8e8e8">
                  <iframe name="ifDrawerList" src="treeview_for_timesheet.jsp" class="bgColor_e8e8e8"  height="385px" width="245px" frameborder="0" scrolling="yes"></iframe>
                </div>
              <%}%>
              <%if( !folderDocInfo.isTreeVisible() ){%>
                <script>
              ...
              <td align="center" valign="top" class="bgColor_e8e8e8 bdrColor_336633" width="755px">
                ...
                <table width="100%"  border="0" cellspacing="1" cellpadding="1" class="bgColor_FFFFFF">
                  <tr>
                    <th width="3%" align="center" class="th669966">
                    ...
                    <th width="65%" align="center" class="th669966"><bean:message key="tbl.head.CSV" /></th>
                  </tr>             
                          ...
                          <%if(folderDocList.getClassName().equalsIgnoreCase("Timesheet") ||(folderDocList.getClassName().equalsIgnoreCase("FAMILY"))){%>
                            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="26px">
                                  <a target=newwin href="b4DocDownloadAction.do?documentId=<bean:write name="folderDocList" property="id" />" title="DownLoad Timesheet" class="dataLink" ></a>
                                </td>
                              </tr>
                            </table>
