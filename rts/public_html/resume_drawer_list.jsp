...
function docEdit(){
  ...
  <body>
    <html:form name="folderDocListForm" action="/folderDocListAction" type="rts.web.actionforms.filesystem.FolderDocListForm" >
          ...
          <!-- header ends here -->
                ...
                <td height="30px" colspan="2">
                  ...
                  <logic:equal name="folderDocInfo" property="listingType" value="<%=FolderDocInfo.SIMPLE_LISTING%>" >
                    ...
                    <%if( !((Boolean)request.getAttribute("isRootFolder")).booleanValue() ){ %>
                      ...
                      <a  onclick="folderDocCut()" class="imgCut" onmouseout="this.className='imgCut'" onmouseover="this.className='imgCut'" title="<bean:message key="tooltips.ResumeCut" />" style="margin-left:2px"></a>
    
                      <a  onclick="folderDocCopy()" class="imgCopy" onmouseout="this.className='imgCopy'" onmouseover="this.className='imgCopy'" title="<bean:message key="tooltips.ResumeCopy" />" style="margin-left:2px"></a>

                      <a  onclick="folderDocPaste()" class="imgPaste" onmouseout="this.className='imgPaste'" onmouseover="this.className='imgPaste'" title="<bean:message key="tooltips.ResumePaste" />" style="margin-left:2px"></a>
            
                      <a  onclick="folderDelete();" class="imgDeleteFolder" onmouseout="this.className='imgDeleteFolder'" onmouseover="this.className='imgDeleteFolder'" title="<bean:message key="tooltips.ResumeDelete" />" style="margin-left:2px"></a>
            
                      <a  onclick="b4CopyMoveFolderDocTo('COPY')" class="imgCopyTo" onmouseout="this.className='imgCopyTo'" onmouseover="this.className='imgCopyTo'" title="<bean:message key="tooltips.ResumeCopyTo" />" style="margin-left:2px"></a>
            
                      <a  onclick="b4CopyMoveFolderDocTo('MOVE')" class="imgMoveTo" onmouseout="this.className='imgMoveTo'" onmouseover="this.className='imgMoveTo'" title="<bean:message key="tooltips.ResumeMoveTo" />" style="margin-left:2px"></a>
            ...
            <%if(!folderDocInfo.isTreeVisible()){%>
              ...
              <table id="searchShowHide" style="display:'';" width="1000px" border="0" align="center" cellpadding="0" cellspacing="0" class="bdrBottomColor_336633">
                <tr>
                  <td height="90px" class="bgColor_e8e8e8 bdrTopColor_FFFFFF" align="center">
          ...
          <td align="center" valign="top" class="bgColor_e8e8e8">
            <table width="100%"  border="0" cellspacing="1" cellpadding="1" class="bgColor_FFFFFF">
              <tr>
                ...
                <th width="21%" align="center" class="th669966"><bean:message key="tbl.head.Name" /></th>
                <th width="20%" align="center" class="th669966"><bean:message key="tbl.head.E-mailId" /></th>
                <th width="37%" align="center" class="th669966"><bean:message key="tbl.head.address" /></th>
                <th width="11%" align="center" class="th669966"><bean:message key="tbl.head.phone" /></th>
                <th width="12%" align="center" class="th669966"><bean:message key="tbl.head.Resume" /></th>
              </tr>             
              ...
              <%if(folderDocLists.size() > 0 ){%>
                ...
                <logic:iterate id="folderDocList" name="folderDocLists" type="rts.web.beans.filesystem.FolderDocList" >
                  ...
                  <%if(folderDocList.getClassName().equalsIgnoreCase("Resume1") ||(folderDocList.getClassName().equalsIgnoreCase("FAMILY"))){%>
                    ...
                    <td valign="top">
                      <bean:write name="folderDocList" property="phone1" />
                    </td>
                    <td valign="top">
