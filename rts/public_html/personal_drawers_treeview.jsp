...
<bean:define id="jsFileLinks" name="Treeview4PersonalList" property="jsFileLinks" />
              ...
              <tr>
                ...
                <td height="30px" colspan="2">
                  ...
                  <logic:equal name="folderDocInfo" property="listingType" value="<%=FolderDocInfo.SIMPLE_LISTING%>" >
                    ...
                    <a  onclick="folderDocRename();" class="imgRename" onmouseout="this.className='imgRename'" onmouseover="this.className='imgRename'" title="<bean:message key="tooltips.FolderDocRename" />" style="margin-left:2px"></a>
                    ...
                    <%if( !((Boolean)request.getAttribute("isRootFolder")).booleanValue() ){ %>
                      ...
                      <a  onclick="folderDocCut()" class="imgCut" onmouseout="this.className='imgCut'" onmouseover="this.className='imgCut'" title="<bean:message key="tooltips.DrawerDocCut" />" style="margin-left:2px"></a>
    
                      <a  onclick="folderDocCopy()" class="imgCopy" onmouseout="this.className='imgCopy'" onmouseover="this.className='imgCopy'" title="<bean:message key="tooltips.DrawerDocCopy" />" style="margin-left:2px"></a>

                      <a  onclick="folderDocPaste()" class="imgPaste" onmouseout="this.className='imgPaste'" onmouseover="this.className='imgPaste'" title="<bean:message key="tooltips.DrawerDocPaste" />" style="margin-left:2px"></a>
            
                      <a  onclick="folderDelete();" class="imgDeleteFolder" onmouseout="this.className='imgDeleteFolder'" onmouseover="this.className='imgDeleteFolder'" title="<bean:message key="tooltips.DrawerDocDelete" />" style="margin-left:2px"></a>
            
                      <a  onclick="b4CopyMoveFolderDocTo('COPY')" class="imgCopyTo" onmouseout="this.className='imgCopyTo'" onmouseover="this.className='imgCopyTo'" title="<bean:message key="tooltips.DrawerDocCopyTo" />" style="margin-left:2px"></a>
            
                      <a  onclick="b4CopyMoveFolderDocTo('MOVE')" class="imgMoveTo" onmouseout="this.className='imgMoveTo'" onmouseover="this.className='imgMoveTo'" title="<bean:message key="tooltips.DrawerDocMoveTo" />" style="margin-left:2px"></a>
            ...
            <tr>
              ...
              <%if( folderDocInfo.isTreeVisible() ){%>
                <div id="treeDiv" class="bdrColor_336633 bgColor_e8e8e8">
                  <iframe name="ifDrawerList" src="treeview_for_personal.jsp" class="bgColor_e8e8e8"  height="385px" width="245px" frameborder="0" scrolling="yes"></iframe>
                </div>
              <%}%>
              <%if( !folderDocInfo.isTreeVisible() ){%>
                <script>
              ...
              <td align="center" valign="top" class="bgColor_e8e8e8 bdrColor_336633" width="755px">
                ...
                <table width="100%"  border="0" cellspacing="1" cellpadding="1" class="bgColor_FFFFFF">
                  <tr>
                    ...
                    <th width="32%" align="center" class="th669966"><bean:message key="tbl.head.Name" /></th>
                    <th width="12%" align="center" class="th669966"><bean:message key="tbl.head.Size" /></th>
                    <th width="25%" align="center" class="th669966"><bean:message key="tbl.head.Type" /></th>
                    <th width="29%" align="center" class="th669966"><bean:message key="tbl.head.ModifiedDate" /></th>
                  </tr>             
                    ...
                    <logic:iterate id="folderDocList" name="folderDocLists" type="rts.web.beans.filesystem.FolderDocList" >
                      ...
                      <%}%>
                        ...
                        <td valign="top">
                          ...
                          <%if(folderDocList.getClassName().equalsIgnoreCase("Document") ||(folderDocList.getClassName().equalsIgnoreCase("FAMILY"))){%>
