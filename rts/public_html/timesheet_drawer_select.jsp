...
<bean:define id="jsFileLinks" name="Treeview4Timesheet" property="jsFileLinks" />
<bean:define id="jsFileName" name="Treeview4Timesheet" property="jsFileName" />
...
String rootFolderPath = "/"+folderDocInfo.getRtsBase()+"/"+userInfo.getTimesheetFolderName();
%>
<html:html>
<head>
