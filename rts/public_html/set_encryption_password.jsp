...
<td align="center">
  ...
  <html:form name="setEncryptionPasswordForm" type="rts.web.actionforms.user.SetEncryptionPasswordForm"  action="/setEncryptionPasswordAction" onsubmit="return validateSetEncryptionPasswordForm(this);">  
    <tr>
