      ...
      */
      function QuotaProgessBar(pgBarId,width,height,scale){
      ...
      function drawPgBar(){
        ...
        var pgPatelWidth=this.pgPatelWidth/this.scale;
        ...
        if( pgPatelWidth>=1.00 ){
      
        }
        if(pgPatelWidth<1.00){
        pgPatelWidth = 1;
        }
        if(pgPatelWidth>width){
        pgPatelWidth=width
        }
