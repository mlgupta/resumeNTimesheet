...
<script>
  ...
  function folderDocNavigate(param){
    ...
    <script>
      ...
      function folderRefresh(){
        ...
        document.forms[0].target = "_self";    
        document.forms[0].action = "drawerListingAction.do";
        document.forms[0].submit();
      }
 ...
 //Called when new drawer button is clicked
  ...
  <body>
    <html:form name="drawerListForm" action="/drawerListingAction" type="rts.web.actionforms.filesystem.DrawerListForm" >
            ...
            <tr align="left" >
              ...
              <td width="140px">
                <table id="tabResume" width="140px" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="5px" class="imgTabLeft"></td>
                    <td width="130px" class="imgTabTile"><div align="center" class="tabText"><bean:message key="lbl.Resume" /></div></td>
                    <td width="5px" class="imgTabRight"></td>
                  </tr>
                </table>
              </td>
