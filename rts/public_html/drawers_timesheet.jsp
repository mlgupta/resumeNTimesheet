...
<script>
  ...
  function folderDocNavigate(param){
    ...
    <script>
      ...
      function folderRefresh(){
        ...
        document.forms[0].target = "_self";    
        document.forms[0].action = "drawerTimesheetListingAction.do";
        document.forms[0].submit();
      }
 ...
 //Called when new drawer button is clicked
  ...
  <body>
    <html:form name="drawerListForm" action="/drawerTimesheetListingAction" type="rts.web.actionforms.filesystem.DrawerListForm" >
            ...
            <tr align="left" >
              <td width="140px">
                <table id="tabPersonal" width="140px" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="130px" class="imgTabTile" align="center"><a  class="tabTextLink" href="b4DrawerListingAction.do?type=personal"><bean:message key="lbl.Personal" /></a></td>
              ...
              <td>
                <table id="tabTimesheet" width="140px" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="5px" class="imgTabLeft"></td>
                    <td width="130px" class="imgTabTile" ><div align="center" class="tabText" ><bean:message key="lbl.Timesheet" /></div></td>
                    <td width="5px" class="imgTabRight"></td>
                  </tr>
                </table>
              </td>
