...
String rootFolderPath = "/"+folderDocInfo.getRtsBase()+"/"+userInfo.getPersonalFolderName()+"/"+userInfo.getDbsLibrarySession().getUser().getPrimaryUserProfile().getHomeFolder().getName();%>
<html:html>
<head>
