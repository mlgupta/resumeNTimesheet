              ...
              <tr>
                <td height="300px" bgcolor="#e8e8e8">
                  <table width="400px" border="0" align="center" class="bdrColor_669966">
                    ...
                    <tr>
                      <td width="97"><a href="b4DrawerListingAction.do?type=personalDrawer" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Drawers','','themes/images/webtop_drawers_over.gif',1)"><img src="themes/images/webtop_drawers.gif" alt="Drawers" name="Drawers" width="75" height="60" border="0" style="margin-left:20px"></a></td>
                      <td width="90"><a href="folderDocMenuClickAction.do?type=resume" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Resumes','','themes/images/webtop_resumes_over.gif',1)"><img src="themes/images/webtop_resumes.gif" alt="Resumes" name="Resumes" width="75" height="60" border="0" style="margin-left:8px"></a></td>
                      <td width="90"><a href="folderDocMenuClickAction.do?type=timesheet" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Timesheets','','themes/images/webtop_timesheet_over.gif',1)"><img src="themes/images/webtop_timesheet.gif" alt="Timesheets" name="Timesheets" width="75" height="60" border="0" style="margin-left:5px"></a></td>
                      <td width="97"><a href="folderDocMenuClickAction.do?type=personal" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('My Documents','','themes/images/webtop_mydoc_over.gif',1)"><img src="themes/images/webtop_mydoc.gif" alt="My Documents" name="My Documents" width="75" height="60" border="0" style="margin-left:2px"></a></td>
                    </tr>
                    <tr>
