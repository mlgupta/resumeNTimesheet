 ...
 *                                                                           *
 *****************************************************************************
 * $Id: DrawerListingAction.java,v 1.11 2005/10/03 12:02:14 suved Exp $
 *****************************************************************************
 */
...
/**
 * Purpose : To list resumes drawers in drawer module    
 * @author              Suved Mishra
 * @version             1.0
...
public class DrawerListingAction extends Action  {
  /**
...
public ActionForward execute( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
  ...
  try{
    ...
    /* check if current folder is the uppermost limit viz:"/companyName/resumes" */
  ...
  logger.debug("Exiting drawerListingAction... ");    
