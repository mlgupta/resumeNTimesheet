 ...
 *                                                                           *
 *****************************************************************************
 * $Id: FolderDocCopyAction.java,v 1.12 2005/10/03 12:46:35 suved Exp $
 *****************************************************************************
 */
...
/**
 * Purpose : To perform copy operation    
 * @author              Suved Mishra
 * @version             1.0
...
public class FolderDocCopyAction extends Action  {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try{
            ...
            /* set ClipBoard to folderDocIds, ClipBoardContent to operation COPY */
