...
/**
 *	Purpose: To display personal documents and drawers list
 *  @author              Suved Mishra
 *  @version             1.0
 * 	Date of creation:    17-08-2005
 * 	Last Modfied by :     
 * 	Last Modfied Date:    
 */

public class PersonalListAction extends Action  {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try{
            ...
            logger.info("Listing items present in the folder : " +
                                                currentFolderPath);
            ...
            /* restrict parents to user homeFolder and not above it */
            while(!dbsFolder.getAnyFolderPath().equals("/"+rootFolder+"/"+
                    userInfo.getPersonalFolderName()+"/"+homeFolderName)){
              ...
              if( currentFolderNameTemp.equalsIgnoreCase(homeFolderName) &&
                  parentFolder.equals(userInfo.getPersonalFolderName())){
                
                currentFolderNameTemp = homeFolderName;
                listOfParents.add(0,currentFolderNameTemp);
                listOfParentsId.add(0,currentFolderIdTemp);
                break;
              }
              ...
              if(userPreferences.getNavigationType() == UserPreferences.FLAT_NAVIGATION){
                  ...
                  if(dbsFolder.getItemCount()<=1){
                    ...
                    ActionMessage actionMessage = new ActionMessage(
                                            "msg.folderdoc.folder_content_item",
                                            dbsFolder.getName(), String.valueOf(
                                            dbsFolder.getItemCount()));
                    
                    actionMessages.add(ActionMessages.GLOBAL_MESSAGE,actionMessage);
                    
                  }else{
                    ActionMessage actionMessage = new ActionMessage(
                                            "msg.folderdoc.folder_content_items",
                                            dbsFolder.getName(), String.valueOf(
                                            dbsFolder.getItemCount()));
            ...
            AdvanceSearchForm advanceSearchForm = (AdvanceSearchForm)
                                                  httpSession.getAttribute(
                                                  "advanceSearchForm");
            ...
            AdvanceSearchBean advanceSearchBean = new AdvanceSearchBean(
                                                            dbsLibrarySession);
            DbsSearch dbsSearch = advanceSearchBean.getSearchObject(
                                advanceSearchForm,folderDocInfo.getRtsType());
            ...
            actionMessages = new ActionMessages();
            ActionMessage actionMessage = new ActionMessage(
                                          "msg.folderdoc.number_of_item_found",
                                          String.valueOf(dbsSearch.getItemCount()));
          ...
          if(actionErrors != null){
              ...
              if(httpSession.getAttribute("IS_SIMPLE_NAVIGATION") != null){
                  ...
                  ActionMessages actionMessagesSession = (ActionMessages)
                                                          httpSession.getAttribute(
                                                          "ActionMessages");
          ...
          logger.debug("folderDocLists.size() :"+
                    ((ArrayList)request.getAttribute("folderDocLists")).size());
