...
/**
 *	Purpose: To display timesheets and drawers list
 *  @author              Suved Mishra
 *  @version             1.0
...
public class TimesheetListAction extends Action  {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try{
            ...
            /* restrict parents to "/companyName/timesheets/" and not above it */
            while(!dbsFolder.getAnyFolderPath().equals("/"+rootFolder+"/"+
              ...
              if( currentFolderNameTemp.equalsIgnoreCase(
                ...
                currentFolderNameTemp = userInfo.getTimesheetFolderName();
                listOfParents.add(0,currentFolderNameTemp);
                listOfParentsId.add(0,currentFolderIdTemp);
                break;
              }
